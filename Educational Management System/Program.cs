using Educational_Management_System.Models;
...
namespace Educational_Management_System
{
    class Program
    {
        ...
        {
            string File_name = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Courses data\\Course data.txt";
        ...
        static void BuildDoctors(ref ArrayList TotalDoctors, ref ArrayList AvailableCourses)
        {
            ...
            string File_name = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Doctors data\\Names.txt";
            using (StreamReader reader = File.OpenText(File_name))
            {
                string line = reader.ReadLine();
                int cnt = 0;
            ...
            // Course
            File_name = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Doctors data\\Courses.txt";
            using (StreamReader reader = File.OpenText(File_name))
            {
                string line = reader.ReadLine();
                int cnt = 0;
        ...
        {
            string File_Name = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Students data\\Names.txt";
            using (StreamReader reader = File.OpenText(File_Name))
            {
                string line = reader.ReadLine();
                int cnt = 0;
            ...
            //Registered Courses
            File_Name = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Students data\\Courses.txt";
            using (StreamReader reader = File.OpenText(File_Name))
            {
                string line = reader.ReadLine();
                int cnt = 0;
        ...
        {
            string filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Courses data\\Assignment.txt";
        ...
        {
            string filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Courses data\\Course data.txt";
            ...
            writer.Close();
            filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Courses data\\Assignment.txt";
        ...
        {
            string filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Students data\\Names.txt";
            StreamWriter writer = new StreamWriter(filename);
            foreach (Student s in TotalStudens)
            {
            ...
            filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Students data\\Courses.txt";
            writer = new StreamWriter(filename);
            foreach (Student s in TotalStudens)
            {
        ...
        {
            string filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Doctors data\\Names.txt";
            StreamWriter writer = new StreamWriter(filename);
            ...
            filename = "D:\\Testing\\C#\\OOP Project\\Educational Management System\\Dummy data\\Doctors data\\Courses.txt";
            writer = new StreamWriter(filename);
            foreach (Doctor d in TotalDoctors)
            {
